...
CREATE TABLE anuncios (
    ...
    fecha_creacion DATETIME NOT NULL,
    precio DECIMAL(10, 2) NOT NULL, -- Ajustar según tus necesidades
...
VALUES 
('Comercio A', NULL, 'comercioA@email.com', 1234567890, 'Calle Principal 123'),
('Comercio B', NULL, 'comercioB@email.com', 9876543210, 'Avenida Secundaria 456'),
('Tienda XYZ', NULL, 'tienda_xyz@email.com', 5551112222, 'Calle Comercial 789'),
('ElectroMart', NULL, 'info@electromart.com', 1237894560, 'Avenida Tecnológica 321'),
('ModaExpress', NULL, 'ventas@modaexpress.com', 9876543211, 'Plaza de la Moda 567'),
('Librería Lectura', NULL, 'info@librerialectura.com', 8765432109, 'Calle de los Libros 234'),
('SuperDeportes', NULL, 'contacto@superdeportes.com', 1112223333, 'Avenida Deportiva 876'),
('Comercio Z', NULL, 'contacto@comercioz.com', 333222111, 'Avenida comercio 222');
...
VALUES 
('reposabrazos', 'imagenes/coches1.jpg', 'reposabrazos con inventario', NOW(), 100, 6, 1, 4),
('asiento', 'imagenes/coches2.jpg', 'asiento piloto y copiloto de diferentes colores', NOW(), 30, 6, 1, 4),
('palo limpiador', 'imagenes/coches3.jpg', 'Para limpiar recobecos', NOW(), 10.99, 6, 1, 4),
('alfombrilla', 'imagenes/coches4.jpg', 'alfombrilla super comoda pa los pies', NOW(), 29.99, 6, 1, 4),
('grafiti', 'imagenes/coches5.jpg', 'grafiti que le sube al coche +5 de velocidad', NOW(), 3.33, 6, 1, 4),
('correa pal balon', 'imagenes/deportes1.jpg','una correa pa ponerle el balon pa no perderlo y que te de tirones', NOW(), 33, 4, 7, 5),
('rodin', 'imagenes/deportes2.jpg', 'quieres ejercitar tu cuerpo fácilmente? pues toma este pedazo de producto', NOW(), 2, 4, 7, 5),
('pulsera balckWatch', 'imagenes/deportes3.jpeg', 'te vas a correr y no sabes la hora?', NOW(), 2, 4, 7, 5),
('zapatillas led', 'imagenes/deportes4.jpg',  'más rápidas que el coche de las pelis KACHAU', NOW(), 78.23, 4, 7, 5),
('saltacuerdas', 'imagenes/deportes5.png', 'Cuerdas para saltar', NOW(), 16, 4, 7, 5),
...
('licuadora', 'imagenes/electrodomesticos3.jpeg', 'pos remueve tambien', NOW(), 70.23, 7, 2, 3),
('plancha', 'imagenes/electrodomesticos4.jpeg', 'plancha', NOW(), 50.23, 7, 2, 3),
('plancha', 'imagenes/electrodomesticos5.jpeg', 'pos remueve tambien', NOW(), 40.23, 7, 2, 3),
('mando USB', 'imagenes/electronica1.jpg', 'mando pa la tele con USB', NOW(), 33.23, 1, 4, 2),
('sensor Online', 'imagenes/electronica2.jpg', 'sensor que puedes controlar Online', NOW(), 54.23, 1, 4, 2),
('alexa', 'imagenes/electronica3.jpg', 'alexa alexa como hacer una tortilla', NOW(), 77.23, 1, 4, 2),
('vlackwatch', 'imagenes/electronica4.jpg', 'reloj mazo guapo', NOW(), 120.23, 1, 4, 2),
('siri', 'imagenes/electronica5.jpg', 'pues como alexa pero mas cara', NOW(), 300, 1, 4, 2),
('La fregonaMopa', 'imagenes/hogar1.jpg', 'pues un palo que friega y mopa', NOW(), 60, 3, 3, 1),
('freidora de aire', 'imagenes/hogar2.jpg', 'pones aquí la comida y se hace por arte de magia', NOW(), 200, 3, 3, 1),
('dispensador de agua', 'imagenes/hogar3.jpg', 'echa agua', NOW(), 30, 3, 3, 1),
('grapadora', 'imagenes/hogar4.jpg', 'grapa hojas', NOW(), 5.99, 3, 3, 1),
('rascadora', 'imagenes/hogar5.jpg', 'rascas la comida y se hace mazo chiquita', NOW(), 9.99, 3, 3, 1),
('libro hablador', 'imagenes/juguetes1.jpeg', 'pos no va, abre el libro y suena', NOW(), 13.99, 5, 8, 6),
('Mochila Squirtle', 'imagenes/juguetes2.jpeg', 'Es una mochila con forma de Squirtle. Mientras escribo esto, he comprado 5.', NOW(), 19.99, 5, 8, 6),
('Piña juguete', 'imagenes/juguetes3.jpg', 'Quien vive en la piña debajo del mar, nadie porque mi perro se la ha comido.', NOW(), 9.99, 5, 8, 6),
('Eva wally para perros', 'imagenes/juguetes4.jpg', 'Eva dispensa chuches para perros, ta weno', NOW(), 39.99, 5, 8, 6),
('Yoda bebé', 'imagenes/juguetes5.png', 'Es el del meme, tengo una moto que hace bibibibiibibib', NOW(), 9.99, 5, 8, 6),
('Milenial', 'imagenes/libro1.jpg','Libro sobre los milenials', NOW(), 19.99, 8, 6, 7),
('Así es la puta vida', 'imagenes/libro2.jpg', 'Libro sobre la puta vida', NOW(), 99.99, 8, 6, 7),
('Alas ruina', 'imagenes/libro3.jpg', 'La ruina que es muy grande', NOW(), 2.99, 8, 6, 7),
('Auronplay', 'imagenes/libro4.jpg', 'Auron play da da le al play', NOW(), 39.99, 8, 6, 7),
('El libro trol del Rubius', 'imagenes/libro5.jpg', 'Buenos días criaturitas del señor', NOW(), 199.99, 8, 6, 7),
('Ropa preso', 'imagenes/ropa1.jpg', 'Aa me llevan a la cárcel', NOW(), 199.99, 2, 5, 8),
('Ropa Mujer', 'imagenes/ropa2.jpg',  'Aaa me llevan diva', NOW(), 19.99, 2, 5, 8),
('Cosplay Dinosaurio', 'imagenes/ropa3.jpg', 'Aaa me llevan dinosaurio', NOW(), 33.33, 2, 5, 8),
('Cosplay otaku', 'imagenes/ropa4.jpg', 'Aaa me llevan otaku sin ducharme', NOW(), 44.33, 2, 5, 8),
('Gel Rammstein', 'imagenes/ropa5.jpg', 'Aaa me llevan a mover la cabeza de arriba a abajo', NOW(), 1000.99, 2, 5, 8);
...
((SELECT id FROM anuncios WHERE titulo = 'alfombrilla'), 'imagenes/coches4.1.png'),
((SELECT id FROM anuncios WHERE titulo = 'alfombrilla'), 'imagenes/coches4.2.png'),
((SELECT id FROM anuncios WHERE titulo = 'alfombrilla'), 'imagenes/coches4.3.png'),
((SELECT id FROM anuncios WHERE titulo = 'alfombrilla'), 'imagenes/coches4.4.png'),
...
((SELECT id FROM anuncios WHERE titulo = 'saltacuerdas'), 'imagenes/deportes5.1.png'),
((SELECT id FROM anuncios WHERE titulo = 'saltacuerdas'), 'imagenes/deportes5.2.png'),
((SELECT id FROM anuncios WHERE titulo = 'saltacuerdas'), 'imagenes/deportes5.3.png'),
...
((SELECT id FROM anuncios WHERE titulo = 'La fregonaMopa'), 'imagenes/hogar1.1.png'),
((SELECT id FROM anuncios WHERE titulo = 'La fregonaMopa'), 'imagenes/hogar1.2.png'),
((SELECT id FROM anuncios WHERE titulo = 'La fregonaMopa'), 'imagenes/hogar1.3.png'),
...
((SELECT id FROM anuncios WHERE titulo = 'Ropa preso'), 'imagenes/ropa1.1.png'),
...
((SELECT id FROM anuncios WHERE titulo = 'Cosplay Dinosaurio'), 'imagenes/ropa3.1.png'),
((SELECT id FROM anuncios WHERE titulo = 'Cosplay Dinosaurio'), 'imagenes/ropa3.2.png'),
((SELECT id FROM anuncios WHERE titulo = 'Cosplay Dinosaurio'), 'imagenes/ropa3.3.png'),
((SELECT id FROM anuncios WHERE titulo = 'Cosplay Dinosaurio'), 'imagenes/ropa3.4.png'),
((SELECT id FROM anuncios WHERE titulo = 'Cosplay otaku'), 'imagenes/ropa4.1.png'),
((SELECT id FROM anuncios WHERE titulo = 'Cosplay otaku'), 'imagenes/ropa4.2.png'),
((SELECT id FROM anuncios WHERE titulo = 'Cosplay otaku'), 'imagenes/ropa4.3.png'),
